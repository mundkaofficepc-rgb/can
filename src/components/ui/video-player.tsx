...
const VideoPlayer = ({ src }: { src: string }) => {
  ...
  return (
    <motion.div
      className="relative w-full max-w-4xl mx-auto rounded-xl overflow-hidden bg-[#11111198] shadow-[0_0_20px_rgba(0,0,0,0.2)] backdrop-blur-sm group"
                ...
                {[0.5, 1, 1.5, 2].map((speed) => (
                  ...
                  >
                    <Button
                      ...
                      size="sm"
                      className={cn(
                        "text-[10px] h-7 px-2 text-white hover:bg-[#111111d1] hover:text-white",
